...
class Long2ReferenceMapStressTest {
    ...
    void randomSequentialOperationsMatchHashMapAcrossHotAndColdRanges() {
        ConcurrentLong2ReferenceMap<String> map = new ConcurrentLong2ReferenceMap<>(-128L, 256L, 4, true, true, true);
    ...
    void concurrentMixedOperationsWithVacuumAndResizeRemainInternallyConsistent() throws Exception {
        ConcurrentLong2ReferenceMap<String> map = new ConcurrentLong2ReferenceMap<>(0L, 1_024L, 4, true, true, true);
    ...
    void concurrentClearDoesNotCorruptSubsequentReuse() throws Exception {
        ConcurrentLong2ReferenceMap<String> map = new ConcurrentLong2ReferenceMap<>(-512L, 1_024L, 4);
        int threads = 4;
        int perThread = 1_000;
    ...
    private static void assertMapMatches(ConcurrentLong2ReferenceMap<String> map, Map<Long, String> expected) {
