...
public final class CountingLong2Reference<V> implements Long2Reference<V> {
    private final Long2Reference<V> delegate;
    private final AtomicLong size = new AtomicLong();

    CountingLong2Reference(Long2Reference<V> delegate) {
        if (delegate == null) {
