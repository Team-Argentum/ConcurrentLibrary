...
public final class PagedChecked<V> implements Long2Reference<V> {
    ...
    PagedChecked(long base, long capacity) {
        if (capacity < 0) {
    ...
    public V get(long key) {
        ...
        Object[] page = pages[(int) (slot >>> PAGE_BITS)];
