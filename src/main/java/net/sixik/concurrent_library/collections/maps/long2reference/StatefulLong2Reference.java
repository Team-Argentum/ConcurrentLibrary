...
public final class StatefulLong2Reference<V> implements Long2ReferenceTable<V> {
    private static final Object NULL_VALUE = new Object();
    private static final Object DELETED_VALUE = new Object();

    private final Long2ReferenceTable<Object> delegate;

    @SuppressWarnings("unchecked")
    public StatefulLong2Reference(Long2ReferenceTable<?> rangeSource) {
        if (rangeSource == null) {
            throw new NullPointerException();
        }
        this.delegate = (Long2ReferenceTable<Object>) rangeSource;
    }
