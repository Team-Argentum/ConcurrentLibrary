...
public final class NullableLong2Reference<V> implements Long2ReferenceTable<V> {
    private static final Object NULL_VALUE = new Object();

    private final Long2ReferenceTable<Object> delegate;

    @SuppressWarnings("unchecked")
    public NullableLong2Reference(Long2ReferenceTable<?> delegate) {
        if (delegate == null) {
            throw new NullPointerException();
        }
        this.delegate = (Long2ReferenceTable<Object>) delegate;
    }
