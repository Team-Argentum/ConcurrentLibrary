...
public final class PaddedDenseChecked<V> implements Long2ReferenceTable<V> {
    ...
    public PaddedDenseChecked(long base, int capacity) {
        if (capacity < 0) {
        ...
        this.stride = 64 / Long2ReferenceLayout.referenceScale();
