...
public class Long2ReferenceMapConcurrentBenchmark {
    ...
    public static class Data {
        ...
        int filled;
        ConcurrentLong2ReferenceMap<Payload> long2ReferenceMap;
        ...
        public void setup() {
            ...
            switch (implementation) {
                case "long2ReferenceMapHot" -> {
                    long2ReferenceMap = new ConcurrentLong2ReferenceMap<>(BASE_KEY, capacity, 12);
                    fillLong2ReferenceMap();
                }
                case "long2ReferenceMapCold" -> {
                    long2ReferenceMap = new ConcurrentLong2ReferenceMap<>(BASE_KEY + capacity * 4L, capacity, 12);
                    fillLong2ReferenceMap();
                }
