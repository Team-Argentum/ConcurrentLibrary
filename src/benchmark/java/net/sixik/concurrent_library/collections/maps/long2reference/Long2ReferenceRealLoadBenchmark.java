...
public class Long2ReferenceRealLoadBenchmark {
    ...
    public static class Long2ReferenceStateData {
        ...
        Long2ReferenceTable<Payload> table;
        Payload[] values;
    ...
    public static class BaselineStateData {
        ...
        ConcurrentLong2ReferenceMap<Payload> long2Reference;
        ...
        public void setup() {
            ...
            long2Reference = new ConcurrentLong2ReferenceMap<>(BASE_KEY, capacity);
    ...
    public Object baseline_get_existing(BaselineStateData data, Cursor cursor) {
        ...
        return switch (data.baseline) {
            case "concurrentLong2ReferenceMap" -> data.long2Reference.get(key);
    ...
    public void baseline_put_overwrite(BaselineStateData data, Cursor cursor, Blackhole blackhole) {
        ...
        switch (data.baseline) {
            case "concurrentLong2ReferenceMap" -> data.long2Reference.put(key, data.replacement(key));
    ...
    private static Long2ReferenceTable<Payload> newTable(String implementation, int capacity) {
        return switch (implementation) {
            ...
            case "nullable" -> new NullableLong2Reference<>(new DenseChecked<>(BASE_KEY, capacity));
            case "counting" -> new CountingLong2Reference<>(new DenseChecked<>(BASE_KEY, capacity));
            case "stateful" -> new StatefulLong2Reference<>(new DenseChecked<>(BASE_KEY, capacity));
