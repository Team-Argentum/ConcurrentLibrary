...
long[] primitiveValues;
        ...
        ConcurrentLong2ReferenceMap<Object> concurrent;
...
primitiveValues = new long[capacity];
            ...
            dense = new DenseChecked<>(0L, capacity);
            concurrent = new ConcurrentLong2ReferenceMap<>(0L, capacity);
...
trivagoLongLongBusyWaiting.put(i, primitiveValues[i]);
    ...
    @Benchmark
    public Object concurrent_map_get(DataSet data, Cursor cursor) {
